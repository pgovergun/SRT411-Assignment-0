...
This assignment is a short task to complete as an introduction to the R programming language, it has 14 todo examples that I have answered below. The assignment starts with two sections that describe how to download and install R and Rstudio, both resources are necessary to learning how to code with R. The first two sections also gives a small tutorial on how to use different directories in Rstudio and how to use libraries in Rstudio.
...
*ToDo*:
Computing the difference between 2014 and the year I started at this university (2015), divided by the difference between 2014 ad the year I was born (1997) and then muliply the result by 100.
...
This section explains a bit about scalrs, vectors and matrices. A scalar is a single value like I assigned to 'c' in the pervious todo. A matrice is like a table with 2 dimensional values and lastly a vector is a one dimentional structure that concatenates any defined values.
...
This section teaches us about how to create a simple graph and plot 100 random numbers on this graph.
